...
GPSData ROSHelper::PoseWithCovarianceStamped2Data(const geometry_msgs::PoseWithCovarianceStampedConstPtr &msg, int id)
{
  GPSData data;
...
WheelData ROSHelper::TwistStamped2Data(const geometry_msgs::TwistWithCovarianceStampedConstPtr &msg) {
  WheelData data;
  data.time = msg->header.stamp.toSec();
